...
<body>
  <div class="popout-timer">
    ...
    <div class="popout-info">
      ...
      ${config.task_name ? `<span class="popout-task" title="${escapeHtml(config.task_name)}">${escapeHtml(config.task_name)}</span>` : ''}
    </div>
...
.popout-task{font-size:11px;color:${textMuted};max-width:280px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
